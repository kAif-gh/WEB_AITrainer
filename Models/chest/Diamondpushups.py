...
def DiamondPushups(camera):
    ...
    while True:
        ...
        try:
            ...
            angle=u.findAngle(frame, 12, 14, 16, True, 45, 180, 30, angleError1=90, angleError2=120)
            angle2=u.findAngle(frame, 11, 13, 15, True, 45, 180, 30, angleError1=90, angleError2=120)
            # Counter logic
            if 180 > angle > 150:
                stage="up"
            if 45 < angle < 75 and stage == 'up':
                stage="down"
                counter+=1
                print(counter, stage)
        ...
        u.affich(frame, "Diamond Push-Ups", counter, stage)
