...
def Pushups(camera):
    ...
    while True:
        ...
        try:
            ...
            angle=u.findAngle(frame, 12, 14, 16, True, 50, 180, 30, angleError1=100, angleError2=120)
            angle2=u.findAngle(frame, 11, 13, 15, True, 50, 180, 30, angleError1=100, angleError2=120)
            # Counter logic
            if 180 > angle > 150:
                stage="up"
            if 50 < angle < 80 and stage == 'up':
                stage="down"
                counter+=1
                print(counter, stage)
        ...
        u.affich(frame, "Push-Ups", counter, stage)
