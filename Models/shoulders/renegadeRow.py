...
def RenegadeRow(camera):
    ...
    while True:
        ...
        try:
            ...
            angle=u.findAngle(frame, 12, 14, 16, True, 90, 180, 20, angleError1=90, angleError2=120)
            angle2=u.findAngle(frame, 11, 13, 15, True, 90, 180, 20, angleError1=90, angleError2=120)
            # Counter logic
            if 180 > angle > 150:
                stage="down"
            if 60 < angle < 90 and stage == 'down':
                stage="up"
                counter+=1
                print(counter)
        ...
        u.affich(frame, "Renegade Row", counter, stage)
